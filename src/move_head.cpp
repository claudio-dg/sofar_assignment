/*
-module: move_head.cpp
-authors: D. Bruzzo, C. Del Gaizo, P. Saade, C. Tsague
-
- Client for Action Service:
-
-	'/head_controller/point_head_action/' : to move Tiago's head
-
- Description:
-
-	this node simply moves tiago's head to a predefined position 
-	in order to to have a better view of the box on the conveyor
-
- . */
